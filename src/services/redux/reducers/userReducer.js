...
export default function updateReducer(state = initialState, action) {
    switch (action.type) {
        ...
        //DOWNLOAD USER END
        //UPDATE SEEN LIST START
        case (updateSeenConstants.REQUEST):
           return {
                ...state,
                requesting: true,
            };
        case (updateSeenConstants.SUCCESS):
            ...
            return {
                ...
                user: {
                    ...state.user,
                    seen: state.user.seen.concat(action.data)
                },
                requesting: false,
            };
        case (updateSeenConstants.FAILURE):
            return {
                ...state,
                requesting: false,
             };
        // UPDATE SEEN LIST END 
        //UPDATE MATCHS LIST START
        case (updateMatchsConstants.REQUEST):
           return {
                ...state,
                requesting: true,
            };
        case (updateMatchsConstants.SUCCESS):
            ...
            return {
                ...
                user: {
                    ...state.user,
                    matchs: state.user.matchs.concat(action.data)
                },
                requesting: false,
            };
        case (updateMatchsConstants.FAILURE):
            return {
                ...state,
                requesting: false,
             };
        // UPDATE MATCHS LIST END 
        //UPDATE FAVORITES LIST START
        case (updateFavoritesConstants.REQUEST):
           return {
                ...state,
                requesting: true,
            };
        case (updateFavoritesConstants.SUCCESS):
            ...
            return {
                ...
                user: {
                    ...state.user,
                    favorites: state.user.favorites.concat(action.data)
                },
                requesting: false,
            };
        case (updateFavoritesConstants.FAILURE):
            return {
                ...state,
                requesting: false,
             };
        // UPDATE FAVORITES LIST END 
        default:
            return state;
    }
}